    ...
    class PostEffectsHelper : MonoBehaviour
    {
            ...
            Camera cameraForProjectionMatrix )
        {
            ...
            for (int i = 0; i < material.passCount; i++)
            {
                ...
                GL.TexCoord2(0.0f, y1); GL.Vertex3(x1, y1, z1);
                GL.TexCoord2(1.0f, y1); GL.Vertex3(x2, y1, z1);
                GL.TexCoord2(1.0f, y2); GL.Vertex3(x2, y2, z1);
                GL.TexCoord2(0.0f, y2); GL.Vertex3(x1, y2, z1);
                GL.End();
            }
            ...
            Material material )
		{
            ...
            for (int i = 0; i < material.passCount; i++)
            {
                ...
                GL.TexCoord2(0.0f, y1); GL.Vertex3(x1, y1, 0.1f);
                GL.TexCoord2(1.0f, y1); GL.Vertex3(x2, y1, 0.1f);
                GL.TexCoord2(1.0f, y2); GL.Vertex3(x2, y2, 0.1f);
                GL.TexCoord2(0.0f, y2); GL.Vertex3(x1, y2, 0.1f);
