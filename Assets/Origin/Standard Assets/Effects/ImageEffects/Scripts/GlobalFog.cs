...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class GlobalFog : PostEffectsBase
	{
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
		{
            ...
            m_fogMaterial.SetVector ("_HeightParams", new Vector4 (Height, fdotC, paramK, HeightDensity*0.5f));
            m_fogMaterial.SetVector ("_DistanceParams", new Vector4 (-Mathf.Max(StartDistance,0.0f), 0, 0, 0));
			...
			m_fogMaterial.SetVector ("_SceneFogMode", new Vector4((int)sceneMode, UseRadialDistance ? 1 : 0, 0, 0));
            ...
            if (DistanceFog && HeightFog)
                ...
                pass = 2; // height only
            CustomGraphicsBlit (source, destination, m_fogMaterial, pass);
        }
